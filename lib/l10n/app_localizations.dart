...
abstract class AppLocalizations {
  ...
  /// No description provided for @ayanun.
  ///
  /// In en, this message translates to:
  /// **'Sura Number'**
  String get ayanun;
  ...
  /// No description provided for @sebhanum.
  ///
  /// In en, this message translates to:
  /// **'Tsabeh Number'**
  String get sebhanum;

  /// No description provided for @sobhanallah.
  ///
  /// In en, this message translates to:
  /// **'Subhan Allah'**
  String get sobhanallah;

  /// No description provided for @radioquran.
  ///
  /// In en, this message translates to:
  /// **'Holy Quran Radio'**
